...
export const metadata: Metadata = {
  title: "Experience",
  description:
    "Work experience of Asad E Bukhari: full-stack development at Ardent Thrive, NEPRA (Pakistan's national power regulator), and PMAS Arid Agriculture University.",
  openGraph: {
    title: "Experience — Asad E Bukhari",
    description:
      "Work experience of Asad E Bukhari: full-stack development at Ardent Thrive, NEPRA, and PMAS Arid Agriculture University.",
